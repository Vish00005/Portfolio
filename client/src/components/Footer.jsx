      ...
      <div className="row">
        ...
        <div className="cl">
          <div className="cl-img">
            <a
              href="https://github.com/Vish00005"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://www.linkedin.com/in/vishal-khimsuriya-06075239b/"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://www.instagram.com/vis.hxlll?igsh=NDliOTQ4OXh6MXVo"
              target="_blank"
              rel="noreferrer"
            >
